<?php
// KBW Best Selling Products
add_shortcode('kbw_best_selling_products', 'kbw_best_selling_products_func');
function kbw_best_selling_products_func($atts, $content = null)
{
    ob_start();
