                ...
                <div class="<?php echo $kbw_header_container_class; ?> p-0">
                    <div class="row-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="header-language">
                            <a href="javascript: void(0)"><img src="<?php echo KBWCHILD_THEME_DIRECTORY_URI . '/assets/img/icons/flag-en.png' ?>" alt="English"></a>
                            <a href="javascript: void(0)"><img src="<?php echo KBWCHILD_THEME_DIRECTORY_URI . '/assets/img/icons/flag-2.png' ?>" alt="Lang 2"></a>
                            <div class="header-search">
                                <a href="javascript: void(0)"><img src="<?php echo KBWCHILD_THEME_DIRECTORY_URI . '/assets/img/icons/icon-search.png' ?>" alt="Lang 2"></a>
                            </div>
